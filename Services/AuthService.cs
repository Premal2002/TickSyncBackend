            ...
            if (userDto.Email != null && userDto.Password != null)
            {
                ...
                if (user != null)
                {
                    ...
                    if (isPasswordValid)
                    {
                        ...
                        var token = new JwtSecurityToken(_configuration["Jwt:Issuer"], _configuration["Jwt:Audience"], claims, expires: DateTime.Now.AddMinutes(60), signingCredentials: signIn);
